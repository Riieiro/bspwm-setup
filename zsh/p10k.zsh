...
#    nodeenv                 # node.js environment (https://github.com/ekalinin/nodeenv)
 ...
 #   taskwarrior             # taskwarrior task count (https://taskwarrior.org/)
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=88
  # Custom icon.
...
#󱇪
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=88
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=88
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=88
...
typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(my_custom_function)
